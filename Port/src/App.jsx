...
export default function Portfolio() {
  ...
  return (
    <div className="w-full min-h-screen bg-gradient-to-br from-slate-950 via-indigo-950 to-slate-950 text-white overflow-x-hidden relative">
      {/* Canvas for cursor tracking animation */}
      <canvas
        ref={canvasRef}
        className="fixed top-0 left-0 w-screen h-screen pointer-events-none z-0"
      ...
      {/* About Section */}
      <div className="w-full py-12 px-4 sm:px-6 lg:px-8 relative" id="about">
              ...
              >
                ...
                <div className="relative bg-slate-900/60 backdrop-blur-sm rounded-3xl border border-slate-800/50 overflow-hidden group-hover:border-slate-700 transition-all duration-500 group-hover:scale-[1.02]">
                  ...
                  <div className="p-4 sm:p-6">
                    ...
                    <div className="flex flex-wrap gap-2 sm:gap-3">
                      <a href={project.github} target="_blank" rel="noopener noreferrer" className="group/btn flex-1 flex items-center justify-center gap-1.5 px-2 sm:px-3 py-2 bg-slate-800/50 hover:bg-slate-800 rounded-lg border border-slate-700/50 hover:border-slate-600 transition-all duration-300 hover:scale-105 min-w-[80px]">
                        <Github size={14} className="sm:w-4 sm:h-4 group-hover/btn:rotate-12 transition-transform duration-300" />
                        <span className="text-xs font-bold text-white">GitHub</span>
                      </a>
                      <a href={project.youtube} target="_blank" rel="noopener noreferrer" className="group/btn flex-1 flex items-center justify-center gap-1.5 px-2 sm:px-3 py-2 bg-red-600/20 hover:bg-red-600/30 rounded-lg border border-red-500/50 hover:border-red-400 transition-all duration-300 hover:scale-105 min-w-[80px]">
                        <Youtube size={14} className="sm:w-4 sm:h-4 group-hover/btn:scale-110 transition-transform duration-300" />
                        <span className="text-xs font-bold text-white">YouTube</span>
                      </a>
                      <a href={project.demo} target="_blank" rel="noopener noreferrer" className="group/btn flex-1 flex items-center justify-center gap-1.5 px-2 sm:px-3 py-2 bg-indigo-600/20 hover:bg-indigo-600/30 rounded-lg border border-indigo-500/50 hover:border-indigo-400 transition-all duration-300 hover:scale-105 min-w-[80px]">
                        <ExternalLink size={14} className="sm:w-4 sm:h-4 group-hover/btn:translate-x-1 group-hover/btn:-translate-y-1 transition-transform duration-300" />
                        <span className="text-xs font-bold text-white">Live Demo</span>
                      </a>
                    </div>
      ...
      <div className="w-full py-12 sm:py-22 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        <div className="w-full relative">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-4 sm:gap-6 md:gap-8 w-full">
            {technologies.map((tech, index) => (
              <div
                key={tech.name}
                className="group relative animate-fade-in-scale"
          ...
          <div className="text-center">
            <div className="mb-10">
              ...
              <div className="flex justify-center gap-6 mb-10">
                ...
                ].map(({ Icon, url, label, gradient }, index) => (
