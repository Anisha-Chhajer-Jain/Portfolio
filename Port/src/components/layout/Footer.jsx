...
export default function Footer() {
  ...
  return (
    <footer className="relative py-12 sm:py-14 md:py-16 px-4 sm:px-6 md:px-8 lg:px-16 bg-gradient-to-b from-gray-900 to-black overflow-hidden">
        ...
        >
          <motion.div variants={itemVariants} className="mb-8 sm:mb-10 md:mb-12">
            ...
            <motion.div variants={itemVariants} className="mb-4 sm:mb-6 md:mb-8">
              <p className="text-lg sm:text-xl md:text-2xl font-semibold bg-gradient-to-r from-purple-400 via-pink-400 to-red-400 bg-clip-text text-transparent mb-1 sm:mb-2">
                Connect With Me
              </p>
              ...
              {socialLinks.map(({ Icon, url, label, gradient }) => (
                ...
                >
                  ...
                  <div className={`
                    ...
                    border border-gray-700 group-hover:border-white/30 
                  ...
                  `}>
                    ...
                    ">
                      ...
                      <div className="absolute -bottom-1 left-1/2 -translate-x-1/2 w-1.5 h-1.5 sm:w-2 sm:h-2 bg-gray-900 border-b border-r border-gray-700 rotate-45" />
                    </div>
                  </div>
                </a>
              ))}
            ...
            <motion.div variants={itemVariants} className="group relative">
              <div className="inline-block">
                <p className="text-sm sm:text-lg md:text-xl lg:text-2xl font-semibold text-gray-300 group-hover:text-white transition-colors duration-300">
                  © 2025 Anisha Chhajer
                </p>
