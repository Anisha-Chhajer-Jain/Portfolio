...
const certificates = [
  ...
  {
    id: 11,
    title: 'NIT Trichy Hackathon',
    org: 'NIT Tiruchirappalli',
    date: '2026',
    color: 'from-blue-400 to-cyan-500',
    image: 'https://res.cloudinary.com/dq7hb3fah/image/upload/v1775879699/Screenshot_2026-04-11_092402_uhqvap.png',
    url: 'https://d8it4huxumps7.cloudfront.net/lambda-pdfs/certificate-images/a1a43a82-b2f1-436a-8028-7881eb381ecf.pdf',
    description: 'Participated in a competitive national-level hackathon at NIT Tiruchirappalli, developing an innovative prototype over an intensive coding weekend.',
    skills: ['Hackathon', 'Problem Solving', 'Prototyping', 'Teamwork'],
    credentialId: 'NIT-TR-2026',
  },
  {
    id: 12,
    ...
    date: '2024',
    color: 'from-yellow-500 to-orange-500',
    image: 'https://res.cloudinary.com/dq7hb3fah/image/upload/v1775879699/Screenshot_2026-04-11_092353_iwg2yn.png',
    url: 'https://d8it4huxumps7.cloudfront.net/lambda-pdfs/certificate-images/4a8a1715-5b44-47b6-bab3-0652b2822a27.pdf',
    description: 'Competed in DevHeat at IIIT Surat, collaborating to build a full-stack solution addressing real-world problem statements.',
    skills: ['Hackathon', 'Full Stack', 'Ideation', 'Development'],
    credentialId: 'DEVHEAT-2024',
  },
  {
    id: 13,
    title: 'SRM Hackathon',
    ...
    date: '2025',
    color: 'from-yellow-500 to-orange-500',
    image: 'https://res.cloudinary.com/dq7hb3fah/image/upload/v1775879699/Screenshot_2026-04-11_092428_yaopie.png',
    url: 'https://d8it4huxumps7.cloudfront.net/lambda-pdfs/certificate-images/38b8235e-32c9-4fe3-9be7-f9208ea9efb1.pdf',
    description: 'Engaged in solving complex algorithmic and development challenges at the SRM Institute of Science and Technology hackathon.',
    skills: ['Hackathon', 'Algorithms', 'Software Eng', 'Coding'],
    credentialId: 'SRM-HACK-2025',
  },
  {
    id: 14,
    title: 'IITBHU - EliteHack 1.0',
    org: 'Govt of India & IIT BHU',
    date: '2026',
    color: 'from-blue-400 to-cyan-500',
    image: 'https://res.cloudinary.com/dq7hb3fah/image/upload/v1775879700/Screenshot_2026-04-11_092419_q6yr9t.png',
    url: 'https://d8it4huxumps7.cloudfront.net/lambda-pdfs/certificate-images/6602113b-8faa-4159-87ab-8d508c2f4911.pdf',
    description: 'Contributed to finding solutions to identify and combat deceptive UI/UX practices and dark patterns on the web.',
    skills: ['UI/UX', 'Browser Ext', 'Web AI', 'Hackathon'],
    credentialId: 'DPBH-2026',
  },
  {
    id: 15,
    title: 'IIM Technology Hackathon',
    org: 'IIM',
    date: '2024',
    color: 'from-yellow-500 to-orange-500',
    image: 'https://res.cloudinary.com/dq7hb3fah/image/upload/v1775879700/Screenshot_2026-04-11_092411_b8e7ac.png',
    url: 'https://d8it4huxumps7.cloudfront.net/lambda-pdfs/certificate-images/e815c56c-95aa-4b57-b7fe-1a1456f286c1.pdf',
    description: 'Bridged the gap between business strategy and tech execution at the IIM hackathon, creating a business-viable technical product.',
    skills: ['Tech-Biz', 'Strategy', 'Product Dev', 'Hackathon'],
    credentialId: 'IIM-TECH-2024',
  },
];
