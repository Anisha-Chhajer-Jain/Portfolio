...
//   return (
//     <div className="pt-24 sm:pt-32 pb-12 sm:pb-20 px-4 sm:px-6 relative bg-gradient-to-br from-slate-950 via-indigo-950 to-slate-900" id="hero">
...
export default function Hero({ isVisible, scrollY, scrollToSection }) {
  ...
  return (
    <div className="pt-24 sm:pt-32 pb-12 sm:pb-20 px-4 sm:px-6 relative bg-gradient-to-br from-slate-950 via-slate-950 to-slate-900" id="hero">
